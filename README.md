...
<p align="center">
  Uma aplicacao responsiva de pokedex para um processo de contratação.
</p>
...
Foram usadas as seguintes libs na aplicacao:
...
- Agora execute **yarn start** OU **npm start**

- Abra seu navegador na porta `http://localhost:3000`
